		...
		<el-form :inline="true" :model="formInline" class="demo-form-inline">
			...
			<el-form-item label="操作分组:">
				...
				<el-radio v-model="radio1" label="2" border @change="handleCheckBox"
					>处置操作</el-radio
				>
				<el-radio v-model="radio1" label="3" border @change="handleOperate">设备操作</el-radio>
          ...
          <!-- 处置操作 -->
					<el-checkbox-group v-model="checkList" v-if="checkBox">
						<el-checkbox v-for="type in types" :key="type" :label="types">{{
							type
						}}</el-checkbox>
					</el-checkbox-group>
          <!-- 登录登出 -->
          ...
          <!-- 设备操作 -->
          <el-checkbox-group v-model="equipmentList" v-if="equipmentShow" >
						<el-checkbox v-for="item in equipment" :key="item" :label="equipment">{{item}}</el-checkbox>
					</el-checkbox-group>
				</el-form-item>
			</div>
			<!-- <div v-if="loginShow">
				<el-form-item label="操作类型:">
					<el-checkbox-group v-model="checkLogin">
						<el-checkbox label="登录系统"></el-checkbox>
						<el-checkbox label="退出系统"></el-checkbox>
					</el-checkbox-group>
				</el-form-item>
...
export default {
	...
	data() {
      ...
      equipmentList:[],//操作设备
      equipment:['新建处置设备','修改处置设备','删除处置设备','新建告警设备','修改告警设备','删除告警设备','操作处置设备']
		}
	},
